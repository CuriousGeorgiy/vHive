...
import (
	...
	"github.com/vhive-serverless/vanilla-firecracker-snapshots/snapshotting"
	"log"
	"path/filepath"
	"strings"
)
...
func (orch *Orchestrator) bootVMFromSnapshot(vmID, revision string) error {
	...
	log.Println("Container snapshot mount path: %s", ctrSnapMount.Source)
	...
	//	DiskDevicePath: ctrSnapMount.Source,
	//}
	//
